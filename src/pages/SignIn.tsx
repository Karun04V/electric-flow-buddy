...
const SignIn = () => {
  ...
  const handleSocialSignIn = (provider: string) => {
    // TODO: Connect to Supabase social authentication
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="border-border bg-card">
          ...
          <CardContent className="space-y-4">
            {/* Social Sign In Buttons - Enterprise Focus */}
            <div className="space-y-2">
              ...
              >
                <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                  ...
                  <path fill="#00B04F" d="M12.623 0H24v11.372H12.623z"/>
        ...
        {/* Additional Info for Organizations */}
        <Card className="border-border bg-card/50">
          <CardContent className="pt-4">
            <div className="text-center space-y-2">
              <h3 className="font-medium text-card-foreground">Enterprise Login</h3>
              <p className="text-xs text-muted-foreground">
                For organizations with SSO, use your company credentials above or contact IT support for assistance.
              </p>
            </div>
          </CardContent>
        </Card>
